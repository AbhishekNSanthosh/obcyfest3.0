...
const page = () => {
  ...
  return (
    <div className="pt-10 p-4 sm:p-6 lg:p-8 text-white">
  <h2 className="text-2xl sm:text-2xl font-bold text-yellow-400 mb-6">
    Event Registrations
  </h2>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
    {events.map((event) => (
      <div
        key={event.id}
        className="bg-gray-900/70 backdrop-blur-md border border-gray-700 rounded-xl p-6 shadow-md hover:shadow-yellow-500/10 transition-all duration-300 flex flex-col"
      >
        {/* Event Title */}
        <h3
